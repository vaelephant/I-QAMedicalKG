...
class MedicalGraph:
    def __init__(self):
        ...
        self.data_path = os.path.join(cur_dir, 'D:/code/QAMedicalKG/data/medical.json')# 获取json文件路径
        # self.g = Graph("http://localhost:7474", username="neo4j", password="gx901205")#老版本neo4j
        self.g = Graph("bolt://localhost:7687", auth=("net4j", "txys666666"))
    # 确认连接
    if Graph:
        print("成功连接到数据库！")
    else:
