import os
import ahocorasick# type: ignore #调用这个库函数，可以网上搜索这个函数库用法
...
class QuestionClassifier:
    ...
    def classify(self, question):
        ...
        # 症状
        if self.check_words(self.symptom_qwds, question) and ('disease' in types):#self.symptom_qwds来自于init，查找self.symptom_qwds是否在question内
